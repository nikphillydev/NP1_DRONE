...
/* CC2500 CONFIGURATION REGISTERS - R/W */
...
class CC2500 {
public:
	CC2500(SPI_HandleTypeDef *spi_handle, GPIO_TypeDef *cs_port, uint16_t cs_pin);

	[[nodiscard]] bool init();


private:
	[[nodiscard]] bool command_strobe(uint8_t strobe);
