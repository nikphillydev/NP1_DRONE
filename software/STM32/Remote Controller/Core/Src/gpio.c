...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO8_Pin|GPIO7_Pin|GPIO1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CC2500_GDO0_Pin MAG_INT_Pin */
  GPIO_InitStruct.Pin = CC2500_GDO0_Pin|MAG_INT_Pin;
  ...
  /*Configure GPIO pin : CC2500_GDO2_Pin */
  GPIO_InitStruct.Pin = CC2500_GDO2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(CC2500_GDO2_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : GPIO8_Pin GPIO7_Pin GPIO1_Pin */
  GPIO_InitStruct.Pin = GPIO8_Pin|GPIO7_Pin|GPIO1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : GPIO6_ARM_EXTI10_Pin */
  GPIO_InitStruct.Pin = GPIO6_ARM_EXTI10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIO6_ARM_EXTI10_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : GPIO4_DISARM_EXTI4_Pin */
  GPIO_InitStruct.Pin = GPIO4_DISARM_EXTI4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIO4_DISARM_EXTI4_GPIO_Port, &GPIO_InitStruct);
