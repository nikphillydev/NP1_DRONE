...
void MX_COMP4_Init(void)
{
  ...
  hcomp4.Init.Hysteresis = COMP_HYSTERESIS_50MV;
...
void HAL_COMP_MspInit(COMP_HandleTypeDef* compHandle)
{
  ...
  /* USER CODE END COMP1_MspInit 0 */
    ...
    PA4     ------> COMP1_INM
    */
    GPIO_InitStruct.Pin = PHA_FILT_Pin|PH_VNA_Pin;
  ...
  /* USER CODE END COMP2_MspInit 0 */
    ...
    PA7     ------> COMP2_INP
    */
    GPIO_InitStruct.Pin = PH_VNB_Pin|PHB_FILT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /* USER CODE END COMP4_MspInit 0 */
    ...
    PB2     ------> COMP4_INM
    */
    GPIO_InitStruct.Pin = PHC_FILT_Pin|PH_VNC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* compHandle)
{
  ...
  /* USER CODE END COMP1_MspDeInit 0 */
    ...
    PA4     ------> COMP1_INM
    */
    HAL_GPIO_DeInit(GPIOA, PHA_FILT_Pin|PH_VNA_Pin);
  ...
  /* USER CODE END COMP2_MspDeInit 0 */
    ...
    PA7     ------> COMP2_INP
    */
    HAL_GPIO_DeInit(GPIOA, PH_VNB_Pin|PHB_FILT_Pin);
  ...
  /* USER CODE END COMP4_MspDeInit 0 */
    ...
    PB2     ------> COMP4_INM
    */
    HAL_GPIO_DeInit(GPIOB, PHC_FILT_Pin|PH_VNC_Pin);
